...
import { AnnouncementsPage, ClassesPage, SchedulePage, ParentsPage, ProfilePage, AdminMessagesPage, MyKPIPage } from "./TeacherPages";
...
export default function TeacherDashboard() {
  ...
  return (
    <div style={{ display:"flex", minHeight:"100vh", position:"relative" }}>
      <BgIcons />
      <TeacherSidebar activePage={page} onNavigate={setPage} teacher={teacher} onLogout={logout} />
      <main style={{ marginLeft:"var(--sidebar-w)", flex:1, minHeight:"100vh", overflowY:"auto", padding:"28px 30px", position:"relative", zIndex:1 }}>
        ...
        {page === "adminmessages"  && <AdminMessagesPage />}
        {page === "mykpi"          && <MyKPIPage />}
      </main>
    </div>
  );
}